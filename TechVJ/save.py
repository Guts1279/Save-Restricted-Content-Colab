...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("CONTACT US", url = "https://t.me/ZEDDYJO")
    ],[
        InlineKeyboardButton('🔍  OFFICIAL CHANNEL', url='https://t.me/Black_MythWukong'),
        InlineKeyboardButton('🤖 PAID TXT TO VIDEO BOT', url='https://t.me/zeddyjo')
	]]
